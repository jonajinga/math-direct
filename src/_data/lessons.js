export default [
  ...
  // Lesson 18: Introduce > and <
  {
    ...
    steps: [
      ...
      { display: "<span class='math-num'>5</span> &nbsp; <span class='math-symbol'>?</span> &nbsp; <span class='math-num'>2</span>", visual: "compare", compareAnswer: ">", action: "show", say: "Which symbol goes here? Tap the right answer. Is 5 more or less than 2?", do: "Let the child tap >, <, or =.", praise: "Greater than! 5 > 2!", correct: "Five is more, so 5 is greater than 2. 5 > 2." },
      { display: "<span class='math-num'>4</span> &nbsp; <span class='math-symbol'>?</span> &nbsp; <span class='math-num'>9</span>", visual: "compare", compareAnswer: "<", action: "show", say: "What about 4 and 9? Tap the right symbol.", do: "Let the child tap.", praise: "Less than! 4 < 9!", correct: "Four is less than nine. 4 < 9." },
    ],
  },
  ...
  // Lesson 19: Review comparing
  {
    ...
    phase: 1,
    steps: [
      { display: "<span class='math-num'>6</span> &nbsp; <span class='math-symbol'>?</span> &nbsp; <span class='math-num'>8</span>", visual: "compare", compareAnswer: "<", action: "show", say: "Tap the right symbol.", do: "Let the child tap.", praise: "6 < 8! Less than!", correct: "Six is less than eight." },
      { display: "<span class='math-num'>10</span> &nbsp; <span class='math-symbol'>?</span> &nbsp; <span class='math-num'>3</span>", visual: "compare", compareAnswer: ">", action: "show", say: "Tap the right symbol.", do: "Let the child tap.", praise: "10 > 3! Greater than!", correct: "Ten is greater than three." },
      { display: "<span class='math-num'>5</span> &nbsp; <span class='math-symbol'>?</span> &nbsp; <span class='math-num'>5</span>", visual: "compare", compareAnswer: "=", action: "show", say: "5 and 5. They are the same! Which symbol? Tap it.", do: "Let the child tap.", praise: "5 = 5! Equals!", correct: "Five equals five. They are the same." },
      { display: "<span class='math-num'>7</span> &nbsp; <span class='math-symbol'>?</span> &nbsp; <span class='math-num'>1</span>", visual: "compare", compareAnswer: ">", action: "show", say: "Tap the right symbol.", do: "Let the child tap.", praise: "7 > 1!", correct: "Seven is greater than one." },
    ],
  },
  ...
  // Lesson 20: Phase 1 Review
  {
    ...
    steps: [
      ...
      { display: "<span class='math-num'>4</span> &nbsp; <span class='math-symbol'>?</span> &nbsp; <span class='math-num'>9</span>", visual: "compare", compareAnswer: "<", action: "show", say: "Tap the right symbol.", do: "Let the child tap.", praise: "4 < 9! Less than!", correct: "Four is less than nine." },
